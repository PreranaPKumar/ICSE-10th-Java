...
public class ShapeTestImage extends JFrame
{ 
    int width=1000; int height=1000;
   int x=450,y=200,a=450,b=200,c=450,d=200;
    public ShapeTestImage()
    { 
    ...
    { 
        ...
        BufferedImage image;
         image = ImageIO.read(new URL(
                            "https://lh3.googleusercontent.com/proxy/vWJjBg70teu7ZOgce3rGQLhV3dKCCyJ8C0ljmZvMPvaUuLdqzBzsLxOZykeoClDZCjqC1cJUI_FamqdvWs8CjKO8FfINncc"));
         //g.drawImage(image,0,0,this);
         /*URL URL= new URL("https://images.app.goo.gl/i6rf7p62HWVorqU7A");
         image= ImageIO.read(URL);*/
        g.drawImage(image,196,154, this);
